...
iconDown1.addEventListener("click",()=>{
    ...
    iconUp1.classList.remove('disabled')
    subnavMobile1.classList.add('open')
})

iconUp1.addEventListener("click", () =>{
    iconDown1.classList.remove('disabled')
...
iconDown2.addEventListener("click",()=>{
    iconDown2.classList.add('disabled')
    iconUp2.classList.remove('disabled')
    subnavMobile2.classList.add('open')
})

iconUp2.addEventListener("click", () =>{
    iconDown2.classList.remove('disabled')
    iconUp2.classList.add('disabled')
...
iconDown3.addEventListener("click",()=>{
    iconDown3.classList.add('disabled')
    iconUp3.classList.remove('disabled')
    subnavMobile3.classList.add('open')
})

iconUp3.addEventListener("click", () =>{
    iconDown3.classList.remove('disabled')
    iconUp3.classList.add('disabled')
...
iconDown4.addEventListener("click",()=>{
    iconDown4.classList.add('disabled')
    iconUp4.classList.remove('disabled')
    subnavMobile4.classList.add('open')
})

iconUp4.addEventListener("click", () =>{
    iconDown4.classList.remove('disabled')
    iconUp4.classList.add('disabled')
